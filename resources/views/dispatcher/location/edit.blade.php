...
<form class="form-horizontal" method="POST" action=" {{ route('dispatcher.location.update', $location->id) }} ">
    @csrf
    ...
    <form class="form-horizontal" method="POST" action=" {{ route('dispatcher.location.destroy', $location->id) }} ">
        @csrf
        <div class="col-md-4">
