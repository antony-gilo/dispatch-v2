...
<form class="form-horizontal" method="POST" action=" {{ route('dispatcher.ambulance.update', $ambulance->id) }} " enctype="multipart/form-data">
    @csrf
...
<form class="form-horizontal" method="POST" action=" {{ route('dispatcher.ambulance.destroy', $ambulance->id) }} ">
        @csrf
        <div class="col-md-4">
