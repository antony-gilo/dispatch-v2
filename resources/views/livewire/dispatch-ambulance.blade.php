        ...
        @if ($currentStep == 1)
            <div class="form-section step-1">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" wire:model="name" placeholder="Caller Full Names" value="{{ old('name') }}" required>
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="phone" id="caller_phone" wire:model="caller_phone" class="form-control" placeholder="Caller's Phone" value="{{ old('caller_phone') }}" required>
                        @error('caller_phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" id="kin_name" wire:model="kin_name" class="form-control" placeholder="Next Of Kin's Names" value="{{ old('kin_name') }}" required>
                        @error('kin_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
        ...
        @if ($currentStep == 2)
            <div class="form-section step-2">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="phone" id="kin_phone" wire:model="kin_phone" class="form-control" placeholder="Kin's Phone" value="{{ old('kin_phone') }}" required>
                        @error('kin_phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" id="victim_name" wire:model="victim_name" class="form-control" placeholder="Victim's Names" value="{{ old('victim_name') }}" required>
                        @error('victim_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" wire:model="victim_gender" required>
        ...
        @if ($currentStep == 3)
            <div class="form-section step-3">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" wire:model="location_id" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" wire:model="driver_assigned" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea wire:model="emergency_details" class="form-control" rows="5" placeholder="Enter Emergency Details Here" required></textarea>
            ...
            <div class="form-group m-t-20">
                ...
                @if ($currentStep == 2 || $currentStep == 3)
                    <div class="col-md-6 float-left">
                        <button class="btn btn-danger btn-block clear:left m-t-20" wire:click="decreaseStep()">Previous</button>
                    </div>
                @endif

                @if ($currentStep == 1 || $currentStep == 2)
                    <div class="col-md-6 float-right">
                        <button class="btn btn-success btn-block clear:right m-t-20" wire:click="increaseStep()">Next</button>
                    </div>
                @endif
