                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ route('supervisor.location.index') }}">All Hospital</a></li>
                                    <li><a href="{{ route('supervisor.location.create') }}">Add Hospital</a></li>
                                </ul>
                            </li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-header-title">
                                    <h4 class="pull-left page-title">Supervisor Dashboard</h4>
